...
export const assetDirectory = [
  {
    id: "logo-branco",
    href: "/brand/triade-branco.png",
    group: "Fundamentos",
    category: "Logo",
    name: "Triade branco",
    description: "Logo principal para fundos escuros, stories e apresentações.",
  },
  {
    id: "logo-preto",
    href: "/brand/triade-preto.png",
    group: "Fundamentos",
    category: "Logo",
    name: "Triade preto",
    description: "Logo principal para fundos claros e documentos.",
  },
  {
    id: "selo",
    href: "/brand/selo-triade-branco.png",
    group: "Fundamentos",
    category: "Selo",
    name: "Selo Triade",
    description: "Símbolo para Membro Triade, ritos, gamificação e comunidade.",
  },
];
